...
int main(int argc, char *argv[]) {
  ...
  /* OUTPUT FILE PREFIX */
  const char std_prefix[] = "/n/home03/amirbitran/ShakhnovichLab/MCPU/sim/DHFR_trunc5/replica/dhfr_t5";

  /* MINIMUM TEMPERATURE */
  MC_TEMP_MIN = 0.1;  /* Previously 0.1*/
  ...
  MC_TEMP = MC_TEMP_MIN + myrank*0.050;// Temperature for this processor
